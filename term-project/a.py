...
def make_alarm(destination, from_date, to_date, passenger, target_price):
    url = "https://api.skypicker.com/flights?fly_from=SEL&fly_to=" + destination + "&date_from=" + from_date + "&date_to=" + from_date + "&return_from=" + to_date + "&return_to=" + to_date + "&adults=" + str(
        passenger) + "&curr=KRW&sort=price&partner=picky"
